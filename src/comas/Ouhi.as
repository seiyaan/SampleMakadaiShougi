package comas {
	...
	public class Ouhi extends Coma {
		
		[Embed(source='Picture/Normal/ouhi.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/kinsyou.png')] private static var Pic21:Class;
		
		public function Ouhi(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"横飛","金将");
		}
		...
		override protected function SetMovingRange() : void  {
			...
			if (_Nari) {
				...
				/// 横飛：横に何マスでも動け、斜めに1マス動ける。飛び越えては行けない。
				for (i = 1; i < 19; i++) {
