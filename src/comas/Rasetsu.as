package comas {
	...
	public class Rasetsu extends Coma {
		
		[Embed(source='Picture/Normal/rasetsu.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/kinsyou.png')] private static var Pic21:Class;
		
		public function Rasetsu(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"羅刹","金将");
		}
