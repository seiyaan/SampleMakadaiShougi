package comas {
	...
	public class Kakugyou extends Coma {
		
		[Embed(source='Picture/Normal/kakugyou.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/kinsyou.png')] private static var Pic21:Class;
		
		public function Kakugyou(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"角行","金将");
		}
