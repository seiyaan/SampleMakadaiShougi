package comas {
	...
	public class Shincho extends Coma {
		
		
		[Embed(source='Picture/Normal/shincho.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/honcho.png')] private static var Pic21:Class;
		
		public function Shincho(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"嗔猪","奔猪");
		}
