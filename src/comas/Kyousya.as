package comas {
	...
	public class Kyousya extends Coma {
		
		[Embed(source='Picture/Normal/kyousya.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/kinsyou.png')] private static var Pic21:Class;
		
		public function Kyousya(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"香車","金将");
		}
