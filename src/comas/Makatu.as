package comas {
	...
	public class Makatu extends Coma {
		[Embed(source='Picture/Normal/makatsu.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/kinsyou.png')] private static var Pic21:Class;
		
		public function Makatu(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"摩羯","金将");
		}
		...
		override protected function SetMovingRange() : void  {
			...
			if (_Nari) {
				...
				// 摩羯：斜めに何マスでも進め、途中で左右どちらにでも90度曲がってさらに何マスでも進める。曲がらなくてもよい。飛び越えては行けない。
				// 角行の動きを1回又は2回できるということである。
