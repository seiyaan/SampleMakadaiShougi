package comas {
	...
	public class Sasya extends Coma {
		
		[Embed(source='Picture/Normal/sasya.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/kinsyou.png')] private static var Pic21:Class;
		
		public function Sasya(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"左車","金将");
		}
