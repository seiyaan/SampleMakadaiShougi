package comas {
	...
	public class Akurou extends Coma {
		
		[Embed(source='Picture/Normal/akurou.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/honrou.png')] private static var Pic21:Class;
		
		public function Akurou(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"悪狼","奔狼");
		}
		
		override protected function SetMovingRange() : void  {
			var i:int;
			if (_Nari) {
				// 奔狼:前三方と横へは何マスでも動けるが、飛び越えたり、後ろへは動けない[3]。
				for (i = 1; i < 19; i++) {
