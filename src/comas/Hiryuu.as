package comas {
	...
	public class Hiryuu extends Coma {
		
		[Embed(source='Picture/Normal/hiryuu.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/kinsyou.png')] private static var Pic21:Class;
		
		public function Hiryuu(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"飛龍","金将");
		}
