package comas {
	...
	public class Usya extends Coma {
		
		[Embed(source='Picture/Normal/usya.png')] private static var Pic11:Class;
		[Embed(source='Picture/Nari/kinsyou.png')] private static var Pic21:Class;
		
		public function Usya(id:int, iX:int, iY:int, iPlayer:Player)
		{
			super(id,iX, iY, iPlayer,"右車","金将");
		}
